...
<form method="POST" action="<?php echo url('/articles/' . $id . '/editer'); ?>" style="max-width: 600px;">
    ...
    <div style="display: flex; gap: 10px;">
        ...
        <a href="<?php echo url('/articles/' . $id); ?>" style="padding: 10px 20px; color: #999; text-decoration: none; border: 1px solid #ddd; border-radius: 4px; display: inline-block;">
            Annuler
        </a>
    </div>
</form>
